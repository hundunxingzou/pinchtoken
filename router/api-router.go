...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.POST("/metamask/pay", middleware.CriticalRateLimit(), controller.RequestMetaMaskTopUp)
			selfRoute.POST("/metamask/verify", middleware.CriticalRateLimit(), controller.VerifyMetaMaskTopUp)
		...
		subscriptionRoute.POST("/metamask/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestMetaMaskPay)
		subscriptionRoute.POST("/metamask/verify", middleware.CriticalRateLimit(), controller.SubscriptionVerifyMetaMaskPay)
		}
