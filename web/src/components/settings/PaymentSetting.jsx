...
import SettingsPaymentGatewayTokenRecharge from '../../pages/Setting/Payment/SettingsPaymentGatewayTokenRecharge';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        <Card style={{ marginTop: '10px' }}>
          <SettingsPaymentGatewayTokenRecharge options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
